...
- **2026-05-07** — ADHD research integrated into the system. Key insight: gym and the morning deep work block are already the two highest-leverage habits — they're mechanically linked. Morning cardio pre-loads dopamine and BDNF for hours; the deep work block that follows is the peak window. These two habits aren't separate — cardio *is* the primer for the learning block. The dedicated learning block being "not protected yet" is the single biggest gap. Protecting the peak window is the next unlock.
