# Reese's Python Learning Log — Structure Reference

*This file documents the structure of PYTHON_LOG.md. Use it as a template when starting fresh sections.*
...
Static section. Update only if role/goals change.
...
Static section. Update only if routine changes.

Includes:
- Day-by-day learning focus table (Mon–Sun)
- Weekly total hours
- Daily rhythm (weekdays) — hour-by-hour breakdown
- Weekend rhythm — hour-by-hour breakdown
...
|-------|-------|-------|----------------|
| [Skill name] | [Level] | [Notes including LEVELED UP flags] | [Date] |
...
|------|--------------|------------|-------------------|--------|-------|
| [Date] | [Description] | [X/10] | [Time] | [Result] | [Details] |
...
Format: bullet points describing the struggle and what was learned.

```
- **[Topic]:** [Description of what went wrong and the takeaway]
```
...
Organized as tables by category:

```
### [Category Name]
| Pattern | When to Use | Key Insight |
|---------|-------------|-------------|
| [Pattern] | [Context] | [Insight] |
```
...
1. [Difficulty] [Problem] ([time]) — [Month]
